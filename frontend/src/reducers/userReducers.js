...
export const userLoginReducer = (state = {loading:true,userInfo:null}, action) => {
    switch (action.type) {
...
export const userDetailsReducer = (state = {loading:false,user:{}}, action) => {
    switch (action.type) {
...
export const userUpdateProfileReducer = (state = {loading:false,user:{},success:false}, action) => {
    switch (action.type) {
